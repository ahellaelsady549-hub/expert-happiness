export type Reciter = { id: string; name: string; folder: string };

export const reciters: Reciter[] = [
  { id: "minshawi", name: "الشيخ محمد صديق المنشاوي (مرتّل)", folder: "Minshawy_Murattal_128kbps" },
  { id: "minshawi-mujawwad", name: "الشيخ المنشاوي (المصحف المجوّد)", folder: "Minshawy_Mujawwad_192kbps" },
  { id: "husary", name: "الشيخ محمود خليل الحصري", folder: "Husary_128kbps" },
  { id: "banna", name: "الشيخ محمود علي البنا", folder: "Mahmoud_Ali_Al_Banna_32kbps" },
  { id: "abdulbasit", name: "الشيخ عبد الباسط عبد الصمد", folder: "Abdul_Basit_Murattal_192kbps" },
];

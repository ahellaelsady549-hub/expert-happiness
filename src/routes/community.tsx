...
import { BadgeCheck, Film, Flag, HelpCircle, Loader2, MessageCircle, PenLine, Send, Trash2 } from "lucide-react";
          ...
          <>
            ...
            {kind === "reel" && (
              <input
                ...
                placeholder="رابط الفيديو (mp4 أو رابط يوتيوب)"
